...
*/
public class ProjectDao extends AbstractDao<Project, Void> {
    ...
    @Override
    protected final Void updateKeyAfterInsert(Project entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(Project entity) {
        return null;
    }
